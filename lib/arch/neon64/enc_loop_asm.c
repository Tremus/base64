...
#define BASE64_NEON64_LOAD(A, B, C) \
...
#define BASE64_NEON64_SHUF(A, B, C) \
	"ushr %[t0].16b, "A".16b,   #2         \n\t" \
	"ushr %[t1].16b, "B".16b,   #4         \n\t" \
	"ushr %[t2].16b, "C".16b,   #6         \n\t" \
	"sli  %[t1].16b, "A".16b,   #4         \n\t" \
...
#define BASE64_NEON64_TRAN(A, B, C, D) \
...
#define BASE64_NEON64_STOR(A, B, C, D) \
...
#define BASE64_NEON64_ROUND() \
	BASE64_NEON64_LOAD("v12", "v13", "v14") \
	BASE64_NEON64_SHUF("v12", "v13", "v14") \
	BASE64_NEON64_TRAN("v12", "v13", "v14", "v15") \
	BASE64_NEON64_STOR("v12", "v13", "v14", "v15")
...
#define BASE64_NEON64_ROUND_A() \
	BASE64_NEON64_SHUF("v2",  "v3",  "v4") \
	BASE64_NEON64_LOAD("v12", "v13", "v14") \
	BASE64_NEON64_TRAN("v2",  "v3",  "v4", "v5") \
	BASE64_NEON64_STOR("v2",  "v3",  "v4", "v5")

// Type B interleaved encoder round. Same as type A, but register sets swapped.
#define BASE64_NEON64_ROUND_B() \
	BASE64_NEON64_SHUF("v12", "v13", "v14") \
	BASE64_NEON64_LOAD("v2",  "v3",  "v4") \
	BASE64_NEON64_TRAN("v12", "v13", "v14", "v15") \
	BASE64_NEON64_STOR("v12", "v13", "v14", "v15")

// The first type A round needs to load its own registers.
#define BASE64_NEON64_ROUND_A_FIRST() \
	BASE64_NEON64_LOAD("v2", "v3", "v4") \
	BASE64_NEON64_ROUND_A()

// The last type B round omits the load for the next step.
#define BASE64_NEON64_ROUND_B_LAST() \
	BASE64_NEON64_SHUF("v12", "v13", "v14") \
	BASE64_NEON64_TRAN("v12", "v13", "v14", "v15") \
	BASE64_NEON64_STOR("v12", "v13", "v14", "v15")
...
enc_loop_neon64 (const uint8_t **s, size_t *slen, uint8_t **o, size_t *olen)
{
	...
	*olen += rounds * 64;	// 64 bytes produced per round.
	...
	__asm__ volatile (
		...
		"    " BASE64_NEON64_ROUND_A_FIRST()
		"    " BASE64_NEON64_ROUND_B()
		"    " BASE64_NEON64_ROUND_A()
		"    " BASE64_NEON64_ROUND_B()
		"    " BASE64_NEON64_ROUND_A()
		"    " BASE64_NEON64_ROUND_B()
		"    " BASE64_NEON64_ROUND_A()
		"    " BASE64_NEON64_ROUND_B_LAST()
		"    b.ne 88b \n\t"
		...
		"3:  " BASE64_NEON64_ROUND()
		"2:  " BASE64_NEON64_ROUND()
		"1:  " BASE64_NEON64_ROUND()
		"0:  \n\t"
